...
<div id="app">
    <header class="">
        <h2 class="text-center" style="margin-top: 6px;">Dear Simon</h2>
    </header>
    ...
    <div class="main">
        ...
        <p>
            All our clients in increased the number of customers thanks to the services provided by our system. <br>
            You can try it here:
